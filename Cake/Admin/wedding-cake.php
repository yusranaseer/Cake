...
if(isset($_POST['add_products'])){
    ...
    $query = "SELECT name FROM wedding WHERE name = '$name'";
    ...
    if(mysqli_num_rows($select_product_name) > 0){
        ...
        $add_product_query = "INSERT INTO wedding(name, price, image, weight) VALUES('$name', '$price', '$image', '$weight')";
...
if(isset($_GET['delete'])){
    ...
    $select_delete = "SELECT image FROM wedding WHERE ID = '$delete_id'";    
    $delete_image_query = mysqli_query($conn, $select_delete);
    $fetch_delete_image = mysqli_fetch_assoc($delete_image_query);
    unlink('uploarded_img/'.$fetch_delete_image['image']);
    $delete_query = "DELETE FROM wedding WHERE id = '$delete_id'";
    mysqli_query($conn,$delete_query);
    header('location:wedding-cake.php');
}
...
if(isset($_POST['update_products'])){
    ...
    mysqli_query($conn, "UPDATE wedding SET name ='$update_name', price ='$update_price', weight ='$update_weight' WHERE id = '$update_p_id'");
    ...
    if(!empty($update_image)){
        if($update_image_size > 2000000){
            ...
            mysqli_query($conn, "UPDATE wedding SET image ='$update_image' WHERE id = '$update_p_id'");
...
<section class="show-products">
    <div class="box-container">
        ...
        <div class="box shadow">
            ...
            <a href="wedding-cake.php?update=<?php echo $fetch_products['id']; ?>" class="option-btn">update</a>
            <a href="wedding-cake.php?delete=<?php echo $fetch_products['id']; ?>" class="delete-btn" onclick="return confirm('Delete this product?');">delete</a>
        </div>
        <?php
        }
            }else{
...
<section class="edit-product-form">
    <?php
        if(isset($_GET['update'])){
            ...
            $select_update = "SELECT * FROM wedding WHERE id = '$update_id'";
...
<script>
    ...
    window.location.href = 'wedding-cake.php';
}
</script>
