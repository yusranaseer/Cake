...
if(isset($_POST['add_products'])){
    ...
    $query = "SELECT name FROM birthday WHERE name = '$name'";
    ...
    if(mysqli_num_rows($select_product_name) > 0){
        ...
        $add_product_query = "INSERT INTO birthday(name, price, image, weight) VALUES('$name', '$price', '$image', '$weight')";
...
if(isset($_GET['delete'])){
    ...
    $select_delete = "SELECT image FROM birthday WHERE ID = '$delete_id'";    
    $delete_image_query = mysqli_query($conn, $select_delete);
    $fetch_delete_image = mysqli_fetch_assoc($delete_image_query);
    unlink('uploarded_img/'.$fetch_delete_image['image']);
    $delete_query = "DELETE FROM birthday WHERE id = '$delete_id'";
    mysqli_query($conn,$delete_query);
    header('location:birthday-cake.php');
}
...
if(isset($_POST['update_products'])){
    ...
    mysqli_query($conn, "UPDATE birthday SET name ='$update_name', price ='$update_price', weight ='$update_weight' WHERE id = '$update_p_id'");
    ...
    if(!empty($update_image)){
        if($update_image_size > 2000000){
            ...
            mysqli_query($conn, "UPDATE birthday SET image ='$update_image' WHERE id = '$update_p_id'");
...
<section class="add-products">
    ...
    <form action="" method="POST" enctype="multipart/form-data">
        ...
        <input type="number" name="weight" min="0" class="box" placeholder="enter product weight" required>
...
<section class="show-products">
    <div class="box-container">
        <?php
            $query_img = "SELECT * FROM birthday";
        ...
        <div class="box shadow">
            ...
            <div class="weight">Weight <?php echo $fetch_products['weight']; ?>kg</div>
            <a href="birthday-cake.php?update=<?php echo $fetch_products['id']; ?>" class="option-btn">update</a>
            <a href="birthday-cake.php?delete=<?php echo $fetch_products['id']; ?>" class="delete-btn" onclick="return confirm('Delete this product?');">delete</a>
        </div>
        <?php
        }
            }else{
...
<section class="edit-product-form">
    <?php
        if(isset($_GET['update'])){
            ...
            $select_update = "SELECT * FROM birthday WHERE id = '$update_id'";
...
<script>
    ...
    window.location.href = 'birthday-cake.php';
}
</script>
