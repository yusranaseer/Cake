...
if(isset($_POST['add_to_cart'])){
    ...
    if(mysqli_num_rows($check_cart_number)> 0 ){
        ...
        $insert_cart = "INSERT INTO cart(user_id, name, price, quantity, image, weight) VALUES ('$user_id','$product_name','$product_price','$product_quantity','$product_image', '$product_weight')";
...
<title>Cherry Cake | Birthday Cakes</title>
</head>
<body>
  ...
  <div class="container text-center">
	<div class="row">
		<div class="col-12 margin-3 margin-3-md">
			...
			<span class="head-3">Birth-Day Cakes</span>
		</div>
	  </div>
  </div>
</div>
...
<div class="container margin-1">
	<div class="row text-center">
		<?php
			$select_query = "SELECT * FROM birthday";
		...
		<div class="col-md-3">			
			<div class="shadow-1 margin-4">				
				...
				<h3 class="wd-product-h3"><strong>Weight </strong><?php echo $fetch_products['weight']; ?>kg</h3>
